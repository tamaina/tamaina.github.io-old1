 ...
 * @since Twenty Sixteen 1.0
 */
function suiransai_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'suiransai' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'suiransai' ),
		'before_widget' => '<div id="%1$s" class="wp-widget card-panel blue darken-4 grey-text text-lighten-5">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Content Bottom 1', 'suiransai' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'suiransai' ),
		'before_widget' => '<div id="%1$s" class="wp-widget card-panel blue darken-4 grey-text text-lighten-5">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Content Bottom 2', 'suiransai' ),
		'id'            => 'sidebar-3',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'suiransai' ),
		'before_widget' => '<div id="%1$s" class="wp-widget card-panel blue darken-4 grey-text text-lighten-5">',
		'after_widget'  => '</div>',
...
add_action( 'widgets_init', 'suiransai_widgets_init' );
...
//http://hacknote.jp/archives/13961/
...
function remove_default_post_screen_metaboxes() {
 ...
 remove_meta_box( 'wpmem-block-meta-id','post','normal' ); // 投稿制限
